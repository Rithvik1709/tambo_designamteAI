...
export async function getDesignExplanation(code: string, framework: string): Promise<any> {
  try {
...
export function generateLearningInsights(code: string, framework: string) {
  return {
    concepts: [
